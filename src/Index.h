...
/**
  ...
  * This "interface" ties properties and methods common to all diff types of index.
  */
...
public:
  ...
  /**
   * Returns pair with address of the tuple, with the specified index, in the relation's binary
  ...
  /**
   * Returns a vector containing address of the tuples selected: a <= K <= b. In this
   * first version, the method is also responsible by printing the tuples to STDOUT.
   * @return vector<int>
   * @param  a
   * @param  b
   */
